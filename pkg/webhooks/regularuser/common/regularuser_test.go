...
func TestMachineConfig(t *testing.T) {
	tests := []regularuserTests{
		...
		{
			testID:          "machineconfig-tuned-serviceaccount",
			targetResource:  "machineconfigs",
			targetKind:      "MachineConfig",
			targetVersion:   "v1",
			targetGroup:     "machineconfiguration.openshift.io",
			username:        "system:serviceaccount:openshift-cluster-node-tuning-operator:cluster-node-tuning-operator",
			userGroups:      []string{"system:authenticated", "system:serviceaccounts", "system:serviceaccounts:openshift-cluster-node-tuning-operator"},
			operation:       admissionv1.Create,
			shouldBeAllowed: true,
		},
		{
			testID:          "machineconfig-mcc-serviceaccount",
			targetResource:  "machineconfigs",
			targetKind:      "MachineConfig",
			targetVersion:   "v1",
			targetGroup:     "machineconfiguration.openshift.io",
			username:        "system:serviceaccount:openshift-machine-config-operator:machine-config-controller",
			userGroups:      []string{"system:authenticated", "system:serviceaccounts", "system:serviceaccounts:openshift-machine-config-operator"},
			operation:       admissionv1.Create,
			shouldBeAllowed: true,
		},
		{
			testID:          "machineconfig-system-admin",
			targetResource:  "machineconfigs",
			targetKind:      "MachineConfig",
			targetVersion:   "v1",
			targetGroup:     "machineconfiguration.openshift.io",
...
func TestSubjectPermissionsClusterVersions(t *testing.T) {
	tests := []regularuserTests{
		...
		{
			testID:          "clusterversions-CVO",
			targetResource:  "clusterversions",
			targetKind:      clusterVersionKind,
			targetVersion:   "v1",
			targetGroup:     clusterVersionGroup,
			username:        "system:serviceaccount:openshift-cluster-version:default",
			userGroups:      []string{"system:serviceaccounts", "system:serviceaccounts:openshift-cluster-version", "system:authenticated"},
			operation:       admissionv1.Delete,
			shouldBeAllowed: true,
		},
		{
			testID:          "clusterversions-CVO-operator",
			targetResource:  "clusterversions",
			targetKind:      clusterVersionKind,
			targetVersion:   "v1",
			targetGroup:     clusterVersionGroup,
			username:        "system:serviceaccount:openshift-cluster-version:cluster-version-operator",
			userGroups:      []string{"system:serviceaccounts", "system:serviceaccounts:openshift-cluster-version", "system:authenticated"},
			operation:       admissionv1.Update,
			shouldBeAllowed: true,
		},
		{
			testID:          "clusterversions-MUO",
			targetResource:  "clusterversions",
			targetKind:      clusterVersionKind,
			targetVersion:   "v1",
			targetGroup:     clusterVersionGroup,
			username:        "system:serviceaccount:openshift-managed-upgrade-operator:managed-upgrade-operator",
			userGroups:      []string{"system:serviceaccounts", "system:serviceaccounts:openshift-managed-upgrade-operator", "system:authenticated"},
			operation:       admissionv1.Update,
			shouldBeAllowed: true,
		},
		{
			testID:          "clusterversions-random-serviceaccount",
			targetResource:  "clusterversions",
			targetKind:      clusterVersionKind,
			targetVersion:   "v1",
			targetGroup:     clusterVersionGroup,
			username:        "system:serviceaccount:hello-world:default",
			userGroups:      []string{"system:serviceaccounts", "system:serviceaccounts:hello-world", "system:authenticated"},
			operation:       admissionv1.Delete,
			shouldBeAllowed: false,
		},
		{
