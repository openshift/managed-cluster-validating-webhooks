...
func TestUsers(t *testing.T) {
	tests := []prometheusruleTestSuites{
		...
		{
			testID:          "regular-user-can-create-prometheusrule-in-redhat-rhoam-observability",
			targetNamespace: "redhat-rhoam-observability",
			targetResource:  "prometheusrule",
			username:        "system:serviceaccounts:redhat-ns",
			userGroups:      []string{"system:serviceaccounts:redhat-ns", "system:authenticated", "system:authenticated:oauth"},
			operation:       admissionv1.Create,
			shouldBeAllowed: true,
		},
		{
			testID:          "regular-user-can-update-prometheusrule-in-redhat-rhoam-observability",
			targetNamespace: "redhat-rhoam-observability",
			targetResource:  "prometheusrule",
			username:        "system:serviceaccounts:redhat-ns",
			userGroups:      []string{"system:serviceaccounts:redhat-ns", "system:authenticated", "system:authenticated:oauth"},
