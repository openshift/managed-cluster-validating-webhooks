...
func TestDedicatedAdmins(t *testing.T) {
	tests := []subscriptionTestSuites{
		{
			testID:           "ded-admin-can-install-ES-logging-44",
		...
		{
			testID:           "ded-admin-can-install-cluster-logging-44",
			username:         "testuser@testgroup.com",
			userGroups:       []string{"dedicated-admin", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
		...
		{
			testID:           "ded-admin-can-install-other-45",
			username:         "testuser@testgroup.com",
			userGroups:       []string{"dedicated-admin", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
		...
		{
			testID:           "ded-admin-can-install-other",
			username:         "testuser@testgroup.com",
			userGroups:       []string{"dedicated-admin", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
		...
		{
			testID:           "ded-admin-cannot-install-cluster-logging-45",
			username:         "testuser@testgroup.com",
			userGroups:       []string{"dedicated-admin", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "cluster-logging",
		...
		{
			testID:           "ded-admin-cannot-install-ES-logging-45",
			username:         "testuser@testgroup.com",
			userGroups:       []string{"dedicated-admin", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "elasticsearch-operator",
		...
		{
			testID:           "ded-admin-cannot-install-cluster-logging-46",
			username:         "testuser@testgroup.com",
			userGroups:       []string{"dedicated-admin", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "cluster-logging",
		...
		{
			testID:           "ded-admin-cannot-install-ES-logging-46",
			username:         "testuser@testgroup.com",
			userGroups:       []string{"dedicated-admin", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "elasticsearch-operator",
...
func TestNormalUser(t *testing.T) {
	...
	tests := []subscriptionTestSuites{
		{
			testID:           "normal-user-can-install-ES-logging-44",
			username:         "testuser@testgroup.com",
		...
		{
			testID:           "normal-user-can-install-cluster-logging-44",
			username:         "testuser@testgroup.com",
			userGroups:       []string{"system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "cluster-logging",
		...
		{
			testID:           "normal-user-can-install-other-45",
			username:         "testuser@testgroup.com",
			userGroups:       []string{"system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "random-cool-operator",
		...
		{
			testID:           "normal-user-can-install-other",
			username:         "testuser@testgroup.com",
			userGroups:       []string{"system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "other-cool-operator",
		...
		{
			testID:           "normal-user-cannot-install-cluster-logging-45",
			username:         "testuser@testgroup.com",
			userGroups:       []string{"system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "cluster-logging",
		...
		{
			testID:           "normal-user-cannot-install-ES-logging-45",
			username:         "testuser@testgroup.com",
			userGroups:       []string{"system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "elasticsearch-operator",
		...
		{
			testID:           "normal-user-cannot-install-cluster-logging-46",
			username:         "testuser@testgroup.com",
			userGroups:       []string{"system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "cluster-logging",
		...
		{
			testID:           "normal-user-cannot-install-ES-logging-46",
			username:         "testuser@testgroup.com",
			userGroups:       []string{"system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "elasticsearch-operator",
...
func TestLayeredAdmins(t *testing.T) {
	...
	tests := []subscriptionTestSuites{
		{
			testID:           "lp-can-install-ES-logging-44",
		...
		{
			testID:           "lp-can-install-cluster-logging-44",
			username:         "testuser@redhat.com",
			userGroups:       []string{"layered-sre-cluster-admins", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "cluster-logging",
		...
		{
			testID:           "lp-can-install-other-45",
			username:         "testuser@redhat.com",
			userGroups:       []string{"layered-sre-cluster-admins", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "random-cool-operator",
		...
		{
			testID:           "lp-cannot-install-cluster-logging-45",
			username:         "testuser@redhat.com",
			userGroups:       []string{"layered-sre-cluster-admins", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "cluster-logging",
		...
		{
			testID:           "lp-cannot-install-ES-logging-45",
			username:         "testuser@redhat.com",
			userGroups:       []string{"layered-sre-cluster-admins", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "elasticsearch-operator",
		...
		{
			testID:           "lp-cannot-install-cluster-logging-46",
			username:         "testuser@redhat.com",
			userGroups:       []string{"layered-sre-cluster-admins", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "cluster-logging",
		...
		{
			testID:           "lp-cannot-install-ES-logging-46",
			username:         "testuser@redhat.com",
			userGroups:       []string{"layered-sre-cluster-admins", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "elasticsearch-operator",
...
func TestPrivilegedUsers(t *testing.T) {
	tests := []subscriptionTestSuites{
		{
			testID:           "kube-admin-can-install-ES-logging-44",
			username:         "kube:admin",
		...
		{
			testID:           "kube-admin-can-install-cluster-logging-44",
			username:         "kube:admin",
			userGroups:       []string{"kube:system", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "cluster-logging",
		...
		{
			testID:           "backplane-cluster-admin-can-install-ES-logging-44",
		...
		{
			testID:           "backplane-cluster-admin-can-install-ES-logging-45",
			username:         "backplane-cluster-admin",
			userGroups:       []string{"system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "elasticsearch-operator",
		...
		{
			testID:           "backplane-cluster-admin-can-install-other-45",
			username:         "backplane-cluster-admin",
			userGroups:       []string{"system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "random-cool-operator",
		...
		{
			testID:           "kube-admin-can-install-other-45",
			username:         "kube:admin",
			userGroups:       []string{"kube:system", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "random-cool-operator",
		...
		{
			testID:           "kube-admin-can-install-other",
			username:         "kube:admin",
			userGroups:       []string{"kube:system", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "other-cool-operator",
		...
		{
			testID:           "backplane-cluster-admin-can-install-other",
			username:         "backplane-cluster-admin",
			userGroups:       []string{"system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "other-cool-operator",
		...
		{
			testID:           "kube-admin-can-install-cluster-logging-45",
			username:         "kube:admin",
			userGroups:       []string{"kube:system", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "cluster-logging",
		...
		{
			testID:           "backplane-cluster-admin-can-install-cluster-logging-45",
			username:         "backplane-cluster-admin",
			userGroups:       []string{"system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "cluster-logging",
		...
		{
			testID:           "kube-admin-can-install-ES-logging-45",
			username:         "kube:admin",
			userGroups:       []string{"kube:system", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "elasticsearch-operator",
		...
		{
			testID:           "kube-admin-can-install-ES-logging-46",
			username:         "kube:admin",
			userGroups:       []string{"kube:system", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "elasticsearch-operator",
		...
		{
			testID:           "backplane-cluster-admin-can-install-ES-logging-46",
			username:         "backplane-cluster-admin",
			userGroups:       []string{"system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "elasticsearch-operator",
		...
		{
			testID:           "kube-admin-can-install-cluster-logging-46",
			username:         "kube:admin",
			userGroups:       []string{"kube:system", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "cluster-logging",
		...
		{
			testID:           "backplane-cluster-admin-can-install-cluster-logging-46",
			username:         "backplane-cluster-admin",
			userGroups:       []string{"system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "cluster-logging",
		...
		{
			testID:           "system-admin-can-install-ES-logging-44",
		...
		{
			testID:           "system-admin-can-install-cluster-logging-44",
			username:         "system:admin",
			userGroups:       []string{"system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "cluster-logging",
		...
		{
			testID:           "system-admin-can-install-other-45",
			username:         "system:admin",
			userGroups:       []string{"system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "random-cool-operator",
		...
		{
			testID:           "system-admin-can-install-other",
			username:         "system:admin",
			userGroups:       []string{"system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "other-cool-operator",
		...
		{
			testID:           "system-admin-can-install-cluster-logging-45",
			username:         "system:admin",
			userGroups:       []string{"system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "cluster-logging",
		...
		{
			testID:           "system-admin-can-install-ES-logging-45",
			username:         "system:admin",
			userGroups:       []string{"system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "elasticsearch-operator",
		...
		{
			testID:           "system-admin-can-install-cluster-logging-46",
			username:         "system:admin",
			userGroups:       []string{"system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "cluster-logging",
		...
		{
			testID:           "system-admin-can-install-ES-logging-46",
			username:         "system:admin",
			userGroups:       []string{"system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "elasticsearch-operator",
		...
		{
			testID:           "sre-admin-can-install-ES-logging-44",
			username:         "testuser@redhat.com",
		...
		{
			testID:           "sre-admin-can-install-cluster-logging-44",
			username:         "testuser@redhat.com",
			userGroups:       []string{"osd-sre-admins", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "cluster-logging",
		...
		{
			testID:           "sre-admin-can-install-other-45",
			username:         "testuser@redhat.com",
			userGroups:       []string{"osd-sre-admins", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "random-cool-operator",
		...
		{
			testID:           "sre-admin-can-install-other",
			username:         "testuser@redhat.com",
			userGroups:       []string{"osd-sre-admins", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "other-cool-operator",
		...
		{
			testID:           "sre-admin-can-install-cluster-logging-45",
			username:         "testuser@redhat.com",
			userGroups:       []string{"osd-sre-admins", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "cluster-logging",
		...
		{
			testID:           "sre-admin-can-install-ES-logging-45",
			username:         "testuser@redhat.com",
			userGroups:       []string{"osd-sre-admins", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "elasticsearch-operator",
		...
		{
			testID:           "sre-admin-can-install-cluster-logging-46",
			username:         "testuser@redhat.com",
			userGroups:       []string{"osd-sre-admins", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "cluster-logging",
		...
		{
			testID:           "sre-admin-can-install-ES-logging-46",
			username:         "testuser@redhat.com",
			userGroups:       []string{"osd-sre-admins", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "elasticsearch-operator",
		...
		{
			testID:           "sre-cluster-admin-can-install-ES-logging-44",
			username:         "testuser@redhat.com",
		...
		{
			testID:           "sre-cluster-admin-can-install-cluster-logging-44",
			username:         "testuser@redhat.com",
			userGroups:       []string{"osd-sre-cluster-admins", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "cluster-logging",
		...
		{
			testID:           "sre-cluster-admin-can-install-other-45",
			username:         "testuser@redhat.com",
			userGroups:       []string{"osd-sre-cluster-admins", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "random-cool-operator",
		...
		{
			testID:           "sre-cluster-admin-can-install-other",
			username:         "testuser@redhat.com",
			userGroups:       []string{"osd-sre-cluster-admins", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "other-cool-operator",
		...
		{
			testID:           "sre-cluster-admin-can-install-cluster-logging-45",
			username:         "testuser@redhat.com",
			userGroups:       []string{"osd-sre-cluster-admins", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "cluster-logging",
		...
		{
			testID:           "sre-cluster-admin-can-install-ES-logging-45",
			username:         "testuser@redhat.com",
			userGroups:       []string{"osd-sre-cluster-admins", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "elasticsearch-operator",
		...
		{
			testID:           "sre-cluster-admin-can-install-cluster-logging-46",
			username:         "testuser@redhat.com",
			userGroups:       []string{"osd-sre-cluster-admins", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "cluster-logging",
		...
		{
			testID:           "sre-cluster-admin-can-install-ES-logging-46",
			username:         "testuser@redhat.com",
			userGroups:       []string{"osd-sre-cluster-admins", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "elasticsearch-operator",
...
func TestGCServiceAccount(t *testing.T) {
	tests := []subscriptionTestSuites{
		{
			testID:           "serviceaccount-can-install-ES-logging-44",
		...
		{
			testID:           "serviceaccount-can-install-cluster-logging-44",
			username:         "system:serviceaccount:kube-system:generic-garbage-collector",
			userGroups:       []string{"system:serviceaccount:kube-system", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "cluster-logging",
		...
		{
			testID:           "serviceaccount-can-install-other-45",
			username:         "system:serviceaccount:kube-system:generic-garbage-collector",
			userGroups:       []string{"system:serviceaccount:kube-system", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "random-cool-operator",
		...
		{
			testID:           "serviceaccount-can-install-other",
			username:         "system:serviceaccount:kube-system:generic-garbage-collector",
			userGroups:       []string{"system:serviceaccount:kube-system", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "other-cool-operator",
		...
		{
			testID:           "serviceaccount-can-install-cluster-logging-45",
			username:         "system:serviceaccount:kube-system:generic-garbage-collector",
			userGroups:       []string{"system:serviceaccount:kube-system", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "cluster-logging",
		...
		{
			testID:           "serviceaccount-can-install-ES-logging-45",
			username:         "system:serviceaccount:kube-system:generic-garbage-collector",
			userGroups:       []string{"system:serviceaccount:kube-system", "system:authenticated", "system:authenticated:oauth"},
			operation:        v1beta1.Create,
			subscriptionName: "elasticsearch-operator",
